...
/**
 * This MapServer class is the entry point for running the JavaSpark web server for the webmap
...
//            ROOT_LRLAT = 37.82280243352756, ROOT_LRLON = -122.2119140625;
     ...
     **/
    private static final String OSM_DB_PATH = "sjtu_osm.xml";
    /**
    ...
    /**
     * assign the Heroku port
     * @return return default port if heroku-port isn't set.
     */
...
//                File in = new File(imgPath);
                InputStream in = MapServer.class.getResourceAsStream(imgPath);
